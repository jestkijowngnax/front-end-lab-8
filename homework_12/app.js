...
const control = {
    ...
    controlSorting: function(val, val2) {
        if (val2 === "up") {
...
const controlSorting = {
    ...
    handleClicks: function() {
        this.$container.on('click', 'li', function() {
            $(this).hasClass('down') || $(this).hasClass('up') ? $(this).toggleClass('up down') : $(this).addClass('down');
            let val = $(this).attr('id');
            let val2 = $(this).attr('class');
            control.controlSorting(val, val2); 
        });
    }
}
